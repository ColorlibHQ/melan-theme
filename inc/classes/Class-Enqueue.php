 ...
 */
	...
	class melan_Enqueue{
		...
		public function melan_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'melan_frontend_enqueue_scripts', ) );
		}

		public function melan_frontend_enqueue_scripts( ){
