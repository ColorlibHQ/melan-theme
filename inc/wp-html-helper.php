...
// image default alt
if ( ! function_exists( 'melan_img_default_alt' ) ) {
	function melan_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'melan_img_tag' ) ) {
	function melan_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'melan_anchor_tag' ) ) {
	function melan_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'melan_heading_tag' ) ) {
	function melan_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'melan_paragraph_tag' ) ) {
	function melan_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'melan_other_tag' ) ) {
	function melan_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'melan_button_element ' ) ) {
	function melan_button_element( array $args ) {
