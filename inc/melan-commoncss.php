...
// enqueue css
function melan_common_custom_css(){
    
    wp_enqueue_style( 'melan-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= melan_opt( 'melan_theme_color' ) != '#131313' ? melan_opt( 'melan_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= melan_opt( 'melan_book_btn_color' ) != '#131313' ? melan_opt('melan_book_btn_color') : '';
		$bookBtnHoverBgColor     	= melan_opt( 'melan_book_btn_hvr_bg_color' ) != '#131313' ? melan_opt('melan_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = melan_opt( 'melan_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = melan_opt( 'melan_navbar_bg_color' ) != '#082b49' ? melan_opt( 'melan_navbar_bg_color') : '';
		$headerTop_col     		  = melan_opt( 'melan_top_header_color' );

		$headerTopBg      		  = melan_opt( 'melan_top_header_bg_color');
		$headerBg          		  = melan_opt( 'melan_header_bg_color') != '#ffffff' ? melan_opt( 'melan_header_bg_color') : '';
		$menuColor          	  = melan_opt( 'melan_header_menu_color' ) != '#131313' ? melan_opt('melan_header_menu_color') : '';
		$menuHoverColor           = melan_opt( 'melan_header_menu_hover_color' ) != '#808080' ? melan_opt('melan_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = melan_opt( 'melan_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = melan_opt( 'melan_header_drop_menu_bg_color' ) != '#ffffff' ? melan_opt('melan_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = melan_opt( 'melan_dropdown_menu_color' ) != '#131313' ? melan_opt('melan_dropdown_menu_color') : '';
		$dropMenuHovColor         = melan_opt( 'melan_dropdown_menu_hover_color' ) != '#808080' ? melan_opt('melan_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = melan_opt( 'melan_footer_widget_bg_color' );
		$footerwHeadColor   	  = melan_opt('melan_footer_widget_heading_color');
		$footerwTextColor   	  = melan_opt('melan_footer_widget_text_color');
		$footerwanchorcolor 	  = melan_opt('melan_footer_widget_anchor_color') != '#ffffff' ? melan_opt('melan_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = melan_opt('melan_footer_widget_anchor_hover_color') != '#ffffff' ? melan_opt('melan_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = melan_opt('melan_fof_bg_color');
		$foftonecolor			  = melan_opt('melan_fof_textone_color');
		$fofttwocolor			  = melan_opt('melan_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = melan_opt('melan_footer_widget_anchor_color') != '#9e9e9e' ? melan_opt('melan_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .melan_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .melan_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'melan-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'melan_common_custom_css', 50 );